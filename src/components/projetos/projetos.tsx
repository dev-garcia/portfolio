  ...
  return (
    <div className="container mx-auto flex flex-col items-center px-5 py-16 md:flex-row lg:px-28">
      ...
      <div className="flex flex-col items-center text-left sm:ml-12 sm:items-start md:mb-0 md:w-1/2 md:pr-16 lg:flex-grow lg:pr-24">
        <h2 className="mb-4 text-left font-black text-2xl text-black tracking-tighter md:text-5xl">
          {title}
        </h2>
        <p className="mb-4 text-left text-base leading-relaxed">{description}</p>
        <div className="flex flex-col justify-center lg:flex-row">
          <button className="mt-auto flex items-center rounded-lg bg-verdeAzulado px-6 py-2 font-semibold text-white ring-offset-2 ring-offset-current transition duration-500 ease-in-out hover:bg-bg focus:shadow-outline focus:outline-none focus:ring-2">
...
const Projetos: React.FC = () => {
  return (
    <section id="projetos" className="mt-20 bg-white font-sans text-blueGray-700">
      <h2 className="pt-8 font-bold text-3xl tracking-tight sm:text-4xl">Projetos</h2>
      <ProjectCard
        title="Vibess"
